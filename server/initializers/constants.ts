...
const STATIC_PATHS = {
  ...
  STREAMING_LIVESTREAMS: {
    HLS: '/static/streaming-livestreams/hls'
  }
}
...
const HLS_STREAMING_LIVESTREAMS_DIRECTORY = join(CONFIG.STORAGE.STREAMING_LIVESTREAMS_DIR, 'hls')
...
export {
  ...
  HLS_STREAMING_LIVESTREAMS_DIRECTORY,
  FEEDS,
  JOB_TTL,
  DEFAULT_THEME_NAME,
  NSFW_POLICY_TYPES,
