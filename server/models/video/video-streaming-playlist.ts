...
export class VideoStreamingPlaylistModel extends Model<Partial<AttributesOnly<VideoStreamingPlaylistModel>>> {
  ...
  // ** Moved ** //
  // static getLiveHlsSha256SegmentsStaticPath (videoUUID: string, isLive: boolean) {
  //   if (isLive) return join('/live', 'segments-sha256', videoUUID)

  //   return join(STATIC_PATHS.STREAMING_LIVESTREAMS.HLS, videoUUID, VideoStreamingPlaylistModel.getHlsSha256SegmentsFilename())
  // }
